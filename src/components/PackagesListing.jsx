            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-3">
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/3-nights-4-days-srinagar-pahalgam-gulmarg-tour"
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/magical-kashmir-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-exotic-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/magnificent-kashmir-valley-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/week-long-holiday-kashmir"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-valley-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/gurez-valley-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-with-gurez-valley-tour"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-offbeat-with-gurez"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/true-gems-of-kashmir-valley"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-blue-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-with-kargil"
                    className="text-blue-600 hover:text-blue-800 font-medium transition-colors"
                  >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-3">
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/glimpses-of-family-tour"
                ...
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/honeymoon-magical-kashmir-tour"
                    className="text-pink-600 hover:text-pink-800 font-medium transition-colors"
                  >
                    4N Kashmir Magic Tour – Lakes, Gardens & Meadows (4 Nights) →
                  </Link>
                ...
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/best-selling-kashmir-tour"
                    className="text-pink-600 hover:text-pink-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/scenic-kashmir-tour"
                    className="text-pink-600 hover:text-pink-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-marvelous-tour"
                    className="text-pink-600 hover:text-pink-800 font-medium transition-colors"
                  >
                ...
                <div className="p-3 hover:bg-pink-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/kashmir-refreshing-tour"
                    className="text-pink-600 hover:text-pink-800 font-medium transition-colors"
                  >
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="space-y-3">
                <div className="p-3 hover:bg-green-50 rounded-lg transition-colors">
                  <Link
                    to="/kashmirtourpackages/srinagar-tour-package"
              ...
              <div className="bg-white rounded-lg shadow-lg p-8">
                ...
                <div className="space-y-3">
                  <div className="p-3 hover:bg-teal-50 rounded-lg transition-colors">
                    <Link
                      to="/kashmirtourpackages/kashmir-summer-tour"
                  ...
                  <div className="p-3 hover:bg-teal-50 rounded-lg transition-colors">
                    <Link
                      to="/kashmirtourpackages/kashmir-autumn-tour"
                      className="text-teal-600 hover:text-teal-800 font-medium transition-colors"
                    >
                  ...
                  <div className="p-3 hover:bg-teal-50 rounded-lg transition-colors">
                    <Link
                      to="/kashmirtourpackages/kashmir-winter-tour"
                      className="text-teal-600 hover:text-teal-800 font-medium transition-colors"
                    >
                  ...
                  <div className="p-3 hover:bg-teal-50 rounded-lg transition-colors">
                    <Link
                      to="/kashmirtourpackages/manali-leh-highway"
                      className="text-teal-600 hover:text-teal-800 font-medium transition-colors"
                    >
                  ...
                  <div className="p-3 hover:bg-teal-50 rounded-lg transition-colors">
                    <Link
                      to="/kashmirtourpackages/kashmir-cultural-tours"
                      className="text-teal-600 hover:text-teal-800 font-medium transition-colors"
                    >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-2">
                  <Link
                    to="/kashmirtourpackages/dal-lake-srinagar-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Dal Lake Srinagar Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/nigeen-lake-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Nigeen Lake Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/betaab-valley-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Betaab Valley Pahalgam →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/doodhpathri-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Doodhpathri Valley →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/thajiwas-glacier-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-2">
                  <Link
                    to="/kashmirtourpackages/pangong-lake-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Pangong Lake Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/nubra-valley-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Nubra Valley & Hunder →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/tso-moriri-lake-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Tso Moriri Lake →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/alchi-monastery-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Alchi Monastery →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/zanskar-valley-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Zanskar Valley →
                  </Link>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-2">
                  <Link
                    to="/kashmirtourpackages/kashmir-houseboat-stay"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Kashmir Houseboat Stay →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/shikara-ride-dal-lake"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Shikara Ride Dal Lake →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/gulmarg-gondola-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Gulmarg Gondola Ride →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/kashmir-skiing-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Kashmir Skiing Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/kashmir-trekking-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Kashmir Trekking →
                  </Link>
              ...
              <div className="bg-white rounded-lg p-6 shadow-md">
                ...
                <div className="space-y-2">
                  <Link
                    to="/kashmirtourpackages/jammu-kashmir-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Jammu Kashmir Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/vaishno-devi-kashmir"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Vaishno Devi + Kashmir →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/kashmir-himachal-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Kashmir Himachal Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/delhi-kashmir-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Delhi to Kashmir Tours →
                  </Link>
                  <Link
                    to="/kashmirtourpackages/kashmir-railway-tour"
                    className="block text-blue-600 hover:text-blue-800 transition-colors text-sm"
                  >
                    Kashmir by Train →
                  </Link>
