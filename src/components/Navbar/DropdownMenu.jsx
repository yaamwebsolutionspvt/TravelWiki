...
const DropdownMenu = ({ isMobile = false, onClose }) => {
  ...
  const getRouteForItem = (sectionTitle, itemName) => {
    const routeMap = {
      "Kashmir Best Sellers": {
        "Quick Kashmir Getaway: 3 Nights in the Valley": "/kashmirtourpackages/3-nights-4-days-srinagar-pahalgam-gulmarg-tour",
        "4N Kashmir Magic Tour – Lakes, Gardens & Meadows (4 Nights)": "/kashmirtourpackages/magical-kashmir-tour",
        "5 Nights Exotic Kashmir Holiday – Lakes & Meadows": "/kashmirtourpackages/kashmir-exotic-tour",
        "Kashmir Grand Discovery: 6 Nights Scenic Expedition": "/kashmirtourpackages/magnificent-kashmir-valley-tour",
        "Marvelous Kashmir: 7 Nights Grand Holiday": "/kashmirtourpackages/week-long-holiday-kashmir",
        "3 Nights Kashmir Valley Tour – Srinagar & Gulmarg": "/kashmirtourpackages/kashmir-valley-tour",
        "Gurez Valley Tour (3 Nights)": "/kashmirtourpackages/gurez-valley-tour",
        "Kashmir with Gurez Valley Tour (5 Nights)": "/kashmirtourpackages/kashmir-with-gurez-valley-tour",
        "Kashmir Offbeat with Gurez (7 Nights)": "/kashmirtourpackages/kashmir-offbeat-with-gurez",
        "True Gems Of Kashmir Valley (8 Nights)": "/kashmirtourpackages/true-gems-of-kashmir-valley",
        "Kashmir with Kargil (6 Nights)": "/kashmirtourpackages/kashmir-with-kargil",
        "Srinagar Tour Packages": "/kashmirtourpackages/srinagar-tour-package",
        "Gulmarg Tour Packages": "/kashmirtourpackages/kashmir-gulmarg-tour",
        "Pahalgam Tour Packages": "/kashmirtourpackages/kashmir-pahalgam-tour",
      ...
      "Kashmir Tours By Duration": {
        "4 Nights / 5 Days": "/kashmirtourpackages/magical-kashmir-tour",
        "5 Nights / 6 Days": "/kashmirtourpackages/kashmir-exotic-tour",
        "6 Nights / 7 Days": "/kashmirtourpackages/magnificent-kashmir-valley-tour",
        "7 Nights / 8 Days": "/kashmirtourpackages/week-long-holiday-kashmir",
        "8 Nights / 9 Days": "/kashmirtourpackages/true-gems-of-kashmir-valley",
        "View All": "/packages-listing"
      },
      "Kashmir Honeymoon Packages": {
        "3 Nights Kashmir Family Tour – Fun & Nature Escape": "/kashmirtourpackages/glimpses-of-family-tour",
        "4N Kashmir Magic Tour – Lakes, Gardens & Meadows (4 Nights)": "/kashmirtourpackages/honeymoon-magical-kashmir-tour",
        "Kashmir Bestseller Tour – 5 Nights Classic Itinerary": "/kashmirtourpackages/best-selling-kashmir-tour",
        "Beautiful Kashmir Tour – 6 Nights Valley Discovery": "/kashmirtourpackages/scenic-kashmir-tour",
        "Grand Kashmir Tour – 7 Nights Valley Experience": "/kashmirtourpackages/kashmir-marvelous-tour",
        "Kashmir Refreshing Tour (3 Nights)": "/kashmirtourpackages/kashmir-refreshing-tour",
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <button
        ref={buttonRef}
        className={`text-gray-800 hover:text-green-600 font-medium flex items-center transition-colors duration-200 ${isMobile
      ...
      <div
        className={`${isMobile
          ...
          : `absolute z-50 mt-2 transition-all duration-200 ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'
          }`
          } bg-white shadow-xl rounded-lg border border-gray-100 ${isMobile
            ? 'w-full'
      ...
      >
        <div
          ...
          className={`${isMobile ? 'p-2' : 'p-2 md:p-3 lg:p-4'} ${isMobile ? 'max-h-[500px]' : 'max-h-[600px]'
        ...
        >
          ...
          <div className={`grid gap-2 md:gap-3 ${isMobile
            ? 'grid-cols-1'
            ...
            {sections.map((section, index) => (
              <div key={index}>
                <button
                  className={`w-full text-left font-semibold text-green-700 mb-1 text-sm md:text-base hover:text-green-800 transition-colors duration-200 flex items-center justify-between py-1 px-3 rounded hover:bg-green-50 ${!isMobile ? 'md:cursor-default md:hover:bg-transparent' : ''
                    }`}
                ...
                >
                  {section.title}
                  {isMobile && (
                    <span className={`transition-transform duration-200 ${expandedSections.includes(index) ? 'rotate-90' : ''
                      }`}>
                      ▸
                    </span>
                  )}
                ...
                <div className={`overflow-hidden transition-all duration-300 ${isMobile
