      ...
      <div className="max-w-6xl mx-auto px-4 mb-6">
        <div className="text-center">
          <p className="text-lg text-gray-600 max-w-4xl mx-auto">
            ...
            <Link to="/places-to-visit-in-pahalgam" className="text-blue-600 hover:text-blue-800 underline">Pahalgam's scenic valleys</Link>, and <Link to="/places-to-visit-in-sonamarg" className="text-blue-600 hover:text-blue-800 underline">Sonamarg's glaciers</Link>. Perfect for <Link to="/packages/kashmir-honeymoon-tour" className="text-blue-600 hover:text-blue-800 underline">honeymoons</Link>, <Link to="/packages/kashmir-family-tour" className="text-blue-600 hover:text-blue-800 underline">family vacations</Link>, and adventure seekers.
          </p>
        </div>
      </div>
