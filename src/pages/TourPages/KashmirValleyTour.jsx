...
const kashmirPackage = "https://res.cloudinary.com/dw1sh368y/image/upload/v1759214293/Alpine_Meadows_Short_Treks_wsjbyv.webp";
    ...
    <>
      ...
      <div className="min-h-screen  mt-4">
        ...
        <div
          ...
          style={{
            backgroundImage: `url(${kashmirPackage})`,
